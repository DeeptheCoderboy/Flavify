...
# dengue_risk = ctrl.Consequent(np.arange(0, 100, 1), 'dengue_risk')             # percentage
...
# dengue_risk['medium'] = fuzz.trimf(dengue_risk.universe, [30, 50, 70])
# dengue_risk['high'] = fuzz.trimf(dengue_risk.universe, [60, 100, 100])
