...
//           {/* Temperature Input */}
//           <div className="mb-6">
//             <label htmlFor="temperature" className="text-black block text-sm font-medium mb-2">
//               Enter Fever Temperature (in °F)
//             </label>
//             <div className="flex items-center gap-4">
//               <span className="text-xl font-semibold text-black min-w-[4rem] text-right">{temperature.toFixed(1)}</span>
//               <input
//                 type="range"
//                 id="temperature"
//                 min="99.1"
...
//           <div className="mb-6">
//             <label htmlFor="plateletCount" className="text-black block text-sm font-medium mb-2">
//               Enter Platelet Count (*1000/uL)
//             </label>
//             <div className="flex items-center gap-4">
//               <span className="text-xl font-semibold text-black min-w-[4rem] text-right">{plateletCount}</span>
//               <input
//                 type="range"
//                 id="plateletCount"
//                 min="10"
...
//           {/* WBC Count Input */}
//           <div className="mb-6">
//             <label htmlFor="wbcCount" className="text-black block text-sm font-medium mb-2">
//               Enter WBC Count (*1000/uL)
//             </label>
//             <div className="flex items-center gap-4">
//               <span className="text-xl font-semibold text-black min-w-[4rem] text-right">{wbcCount}</span>
//               <input
//                 type="range"
//                 id="wbcCount"
//                 min="1"
...
//             className="w-full bg-red-600 hover:bg-red-700 text-black font-semibold py-3 rounded-lg transition-colors duration-300 transform shadow-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50"
//           >
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#fffaf0] flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-2xl bg-[#ffe4e6] text-black shadow-lg rounded-xl border border-red-200 p-6">
